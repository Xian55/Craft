...
// furnaces: server-owned block-entity + smelting (fetch on open, write slots on
// change/close, break spills; server advances the smelt and broadcasts SV_FURNACE)
void net_send_furnace_get(int x, int y, int z);
void net_send_furnace_set(int x, int y, int z); // reads furnace_peek(x,y,z)
